...
if ($this->message) {
	...
	echo '<div class="uk-form-row mue-user-info-row mue-row1"><div class="uk-form-label mue-user-info-label uk-text-bold">From</div><div class="uk-form-controls uk-form-controls-text mue-user-info-hdr">'.$this->message->name.'</div></div>';
