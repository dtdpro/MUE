...
if ($cfg->subscribe){
	if ($numsubs) {
		if (!$sub) {
			echo '<div class="mue-user-info-row mue-row1"><div class="mue-user-info-label">Subscription Status</div><div class="mue-user-info-value">Expired <a href="'.JRoute::_('index.php?option=com_mue&view=subscribe').'" class="button uk-button">Renew Subscription</a></div></div>';
		} else {
		...
		echo '<div class="mue-user-info-row mue-row1"><div class="mue-user-info-label">Subscription Status</div><div class="mue-user-info-value">None <a href="'.JRoute::_('index.php?option=com_mue&view=subscribe').'" class="button uk-button">Add Subscription</a></div></div>';
	}
}
